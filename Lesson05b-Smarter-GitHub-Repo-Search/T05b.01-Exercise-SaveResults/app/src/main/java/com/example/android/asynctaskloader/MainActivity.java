...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SEARCH_JSON_KEY = "search";
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String searchJsonString = mSearchResultsTextView.getText().toString();

        outState.putString(QUERY_URL_KEY, queryURLString);
        outState.putString(SEARCH_JSON_KEY, searchJsonString);
    }
}